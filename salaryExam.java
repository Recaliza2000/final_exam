...
public class salaryExam{
    public static void main(String[] args) {  
        ...
        if(aSalary < 250000){
            ...
            float tax_excess = aSalary - 400000;
        ...
        else if(aSalary >= 800000 && aSalary < 2000000){
            float tax_excess = aSalary - 800000;
        ...
        else if(aSalary >= 2000000 && aSalary < 8000000){
            float tax_excess = aSalary - 2000000;
        ...
        else if(aSalary >= 8000000){
            float tax_excess = aSalary - 8000000;
